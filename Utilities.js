...
var aggregators = function (tpl) {
  return {
    ...
    'Lister les valeurs uniques': tpl.listUnique(', '),
    'Somme': tpl.sum(usFmt),
    ...
    'Somme cumulée': tpl.sumOverSum(usFmt),
    'Somme en fraction du total': tpl.fractionOf(tpl.sum(), 'total', usFmtPct),
    'Somme en fraction des lignes': tpl.fractionOf(tpl.sum(), 'row', usFmtPct),
    'Somme en fraction des colonnes': tpl.fractionOf(tpl.sum(), 'col', usFmtPct),
    'Nombre en fraction du total': tpl.fractionOf(tpl.count(), 'total', usFmtPct),
    'Nombre en fraction des lignes': tpl.fractionOf(tpl.count(), 'row', usFmtPct),
    'Nombre en fraction des colonnes': tpl.fractionOf(tpl.count(), 'col', usFmtPct)
  };
}(aggregatorTemplates);
...
var locales = {
  en: {
    ...
    localeStrings: {
      ...
      computeError: "Une erreur s'est produite lors du calcul des résultats du tableau croisé dynamique.",
      uiRenderError: "Une erreur s'est produite lors du rendu de l'interface du tableau croisé dynamique.",
      selectAll: "Tout sélectionner",
      selectNone: "Ne rien sélectionner",
      tooMany: "(trop nombreux pour être listés)",

  ...
  var TableRenderer = function (_React$PureComponent) {
    ...
    _createClass(TableRenderer, [{
      ...
      value: function render() {
        ...
        var localeStrings = this.props.localeStrings;
        var defaultTotals = this.props.defaultTotals;
          ...
          _react2.default.createElement(
            ...
            rowAttrs.length !== 0 && _react2.default.createElement(
              ...
              _react2.default.createElement(
                'th',
                { className: 'pvtTotalLabel' },
                colAttrs.length === 0 ? localeStrings.totals || 'Totals' : null
              )
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                defaultTotals || grandTotalAggregator.format(grandTotalAggregator.value())
              )
            )
          )
        );
...
exports.default = {
  'Tableau': makeRenderer(),
  'Tableau Heatmap': makeRenderer({ heatmapMode: 'full' }),
  'Tableau Heatmap Colonne': makeRenderer({ heatmapMode: 'col' }),
  'Tableau Heatmap Ligne': makeRenderer({ heatmapMode: 'row' }),

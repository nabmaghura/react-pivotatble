...
export default function createPlotlyRenderers(PlotlyComponent) {
  return {
    'Graphique en colonnes groupées': makeRenderer(
      PlotlyComponent,
      {type: 'bar'},
      {barmode: 'group'}
    ),
    'Graphique en colonnes empilées': makeRenderer(
      PlotlyComponent,
      {type: 'bar'},
      {barmode: 'relative'}
    ),
    'Graphique en barres groupées': makeRenderer(
      PlotlyComponent,
      {type: 'bar', orientation: 'h'},
      {barmode: 'group'},
      true
    ),
    'Graphique en barres empilées': makeRenderer(
      PlotlyComponent,
      {type: 'bar', orientation: 'h'},
      {barmode: 'relative'},
      true
    ...
    'Graphique à secteurs multiples': makeRenderer(
      PlotlyComponent,

...
function createPlotlyRenderers(PlotlyComponent) {
  return {
    'Graphique en colonnes groupées': makeRenderer(PlotlyComponent, { type: 'bar' }, { barmode: 'group' }),
    'Graphique en colonnes empilées': makeRenderer(PlotlyComponent, { type: 'bar' }, { barmode: 'relative' }),
    'Graphique en barres groupées': makeRenderer(PlotlyComponent, { type: 'bar', orientation: 'h' }, { barmode: 'group' }, true),
    'Graphique en barres empilées': makeRenderer(PlotlyComponent, { type: 'bar', orientation: 'h' }, { barmode: 'relative' }, true),
    'Graphique en ligne': makeRenderer(PlotlyComponent),
    'Graphique en points': makeRenderer(PlotlyComponent, { mode: 'markers' }, {}, true),
    'Graphique en aires': makeRenderer(PlotlyComponent, { stackgroup: 1 }),
    'Graphique en nuage de points': makeScatterRenderer(PlotlyComponent),
    'Graphique à secteurs multiples': makeRenderer(PlotlyComponent, { type: 'pie', scalegroup: 1, hoverinfo: 'label+value', textinfo: 'none' }, {}, true)
  };
}
